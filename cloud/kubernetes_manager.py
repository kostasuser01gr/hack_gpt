...
class KubernetesManager:
    ...
    def create_namespace(self, namespace: str) -> bool:
        ...
        try:
            ...
            try:
                self.v1.read_namespace(namespace)  # type: ignore[union-attr]
            ...
            self.v1.create_namespace(ns_body)  # type: ignore[union-attr]
    ...
    def create_deployment(self, config: DeploymentConfig) -> bool:
        ...
        try:
            ...
            container = client.V1Container(
                name=config.name,
                image=config.image,
                ports=[client.V1ContainerPort(container_port=port["port"]) for port in config.ports],
            ...
            deployment = client.V1Deployment(
                api_version="apps/v1",
                kind="Deployment",
                metadata=client.V1ObjectMeta(name=config.name, namespace=config.namespace, labels=config.labels),
                spec=deployment_spec,
            )

            # Apply deployment
            try:
                self.apps_v1.create_namespaced_deployment(  # type: ignore[union-attr]
                    namespace=config.namespace, body=deployment
                )
                self.logger.info(f"Created deployment: {config.name}")
            except ApiException as e:
                if e.status == 409:  # Already exists
                    self.apps_v1.patch_namespaced_deployment(  # type: ignore[union-attr]
    ...
    def create_service(self, config: ServiceConfig) -> bool:
        ...
        try:
            ...
            # Create service spec
            service_spec = client.V1ServiceSpec(selector=config.selector, ports=service_ports, type=config.service_type)
            ...
            # Apply service
            try:
                self.v1.create_namespaced_service(  # type: ignore[union-attr]
                    namespace=config.namespace, body=service
                )
                self.logger.info(f"Created service: {config.name}")
            except ApiException as e:
                if e.status == 409:  # Already exists
                    self.v1.patch_namespaced_service(  # type: ignore[union-attr]
    ...
    def create_configmap(self, name: str, data: dict[str, str], namespace: str | None = None) -> bool:
        ...
        try:
            ...
            # Apply ConfigMap
            try:
                self.v1.create_namespaced_config_map(  # type: ignore[union-attr]
                    namespace=namespace, body=configmap
                )
                self.logger.info(f"Created ConfigMap: {name}")
            except ApiException as e:
                if e.status == 409:  # Already exists
                    self.v1.patch_namespaced_config_map(  # type: ignore[union-attr]
    ...
    def create_secret(
        ...
        try:
            ...
            # Apply Secret
            try:
                self.v1.create_namespaced_secret(namespace=namespace, body=secret)  # type: ignore[union-attr]
                self.logger.info(f"Created Secret: {name}")
            except ApiException as e:
                if e.status == 409:  # Already exists
                    self.v1.patch_namespaced_secret(  # type: ignore[union-attr]
    ...
    def create_ingress(
        ...
        try:
                    ...
                    path = client.V1HTTPIngressPath(
                        ...
                        backend=client.V1IngressBackend(
                            service=client.V1IngressServiceBackend(
                                ...
                                port=client.V1ServiceBackendPort(number=path_config["service_port"]),
                            )
                        ),
                    )
                    paths.append(path)
            ...
            # Apply ingress
            try:
                self.networking_v1.create_namespaced_ingress(  # type: ignore[union-attr]
                    namespace=namespace, body=ingress
                )
                self.logger.info(f"Created Ingress: {name}")
            except ApiException as e:
                if e.status == 409:  # Already exists
                    self.networking_v1.patch_namespaced_ingress(  # type: ignore[union-attr]
    ...
    def scale_deployment(self, deployment_name: str, replicas: int, namespace: str | None = None) -> bool:
        ...
        try:
            ...
            deployment = self.apps_v1.read_namespaced_deployment(  # type: ignore[union-attr]
    ...
    def get_deployment_status(self, deployment_name: str, namespace: str | None = None) -> dict[str, Any]:
    ...
    def get_pod_logs(
        ...
        try:
            return self.v1.read_namespaced_pod_log(  # type: ignore[union-attr]
                name=pod_name,
                namespace=namespace,
                container=container,
    ...
    def get_pods_by_label(self, label_selector: str, namespace: str | None = None) -> list[dict[str, Any]]:
        ...
        try:
            pod_list = self.v1.list_namespaced_pod(  # type: ignore[union-attr]
    ...
    def delete_deployment(self, deployment_name: str, namespace: str | None = None) -> bool:
        """Delete a deployment"""
        if not self.is_kubernetes_available():
            return False
        ...
        try:
            self.apps_v1.delete_namespaced_deployment(  # type: ignore[union-attr]
                name=deployment_name, namespace=namespace
            )
    ...
    def delete_service(self, service_name: str, namespace: str | None = None) -> bool:
        """Delete a service"""
        if not self.is_kubernetes_available():
            return False
        ...
        try:
            self.v1.delete_namespaced_service(name=service_name, namespace=namespace)  # type: ignore[union-attr]
    ...
    def apply_yaml(self, yaml_content: str, namespace: str | None = None) -> bool:
    ...
    def _apply_resource_with_kubectl(self, resource: dict[str, Any], namespace: str | None = None):
...
"""
    ...
    def cleanup(self, namespace: str | None = None):
        ...
        try:
            ...
            self.v1.delete_namespace(name=namespace)  # type: ignore[union-attr]
