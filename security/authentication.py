    ...
    def generate_compliance_report(
        ...
        return {
            ...
            "statistics": {
                ...
                "unique_users": len({log.user_id for log in audit_logs}),
...
class LDAPAuthenticator:
    ...
    def authenticate(self, username: str, password: str) -> AuthResult:
        ...
        try:
            ...
            if not existing_user:
                ...
                db.update_user_login(str(user_id))
            ...
            return AuthResult(False, None, None, None, [], None, f"Authentication error: {e!s}")
    ...
    def _determine_role_from_groups(self, member_of) -> str:
        ...
        if any("hackgpt-senior" in group or "pentest-senior" in group for group in groups):
            return Role.SENIOR_ANALYST.value
        if any("hackgpt-analyst" in group or "pentest-analyst" in group for group in groups):
    ...
    def _generate_jwt_token(self, user_id: str, username: str, role: str) -> str:
        ...
        payload = {
            ...
            "exp": datetime.now(tz=timezone.utc) + timedelta(hours=8),  # 8 hour expiration
        }
...
class LocalAuthenticator:
    ...
    def create_user(self, username: str, email: str, password: str, role: str = Role.ANALYST.value) -> str:
        ...
        return self.db.create_user(username, email, password_hash, role)
        ...
        try:
            ...
            if not secret_key:
                return AuthResult(
                    ...
                    [],
                    None,
                    "Server JWT secret not configured",
                )
            ...
            return AuthResult(False, None, None, None, [], None, f"Invalid token: {e!s}")
